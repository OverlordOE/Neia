...
module.exports = {
	...
	rare() {
		...
		loot.add({ name: 'Motorcycle', amount: [6, 3] }, 20);
		loot.add({ name: 'Car', amount: [3, 1] }, 21);
		loot.add({ name: 'Sailboat', amount: [1, 0] }, 10);
		loot.add({ name: 'Motorboat', amount: [2, 1] }, 20);
	...
	legendary() {
		// cost 80k
		const loot = new LootTable();
		loot.add({ name: 'Rijkszwaard', amount: [1, 0] }, 5);
		loot.add({ name: 'Water', amount: [3, 1] }, 17);
