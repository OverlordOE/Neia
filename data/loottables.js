...
rare.add({ name: 'Healing Potion', amount: [1, 0] }, 100);
rare.add({ name: 'Healing Potion', amount: [2, 0] }, 60);
...
epic.add({ name: 'Healing Potion', amount: [5, 2] }, 100);
...
mystery.add({ name: 'Epic Chest', amount: [1, 0] }, 100);
mystery.add({ name: 'Rare Chest', amount: [1, 0] }, 100);
mystery.add({ name: 'Protection', amount: [1, 0] }, 100);
mystery.add({ name: 'Healing Potion', amount: [1, 0] }, 100);
